...
def main():
    ...
    with tf.Session() as sess:
        ...
        for fileName in os.listdir(TEST_IMAGES_DIR):
            ...
            try:
                (strClassification, confidence) = classify_image(fileName, sess, np, classifications)
...
def classify_image(fileName, sess, np, classifications):
    """
    ...
    if not (fileType.endswith(".jpg") or fileType.endswith(".jpeg") or fileType.endswith(".png")):
        return
    # end if
    ...
    """print("reading file:", cv2.imread("C:/Users/Alex/OneDrive/Pictures/opxhburb9cx01.jpg"))
    print("\n\n\n\n\n")
    nparray = np.fromstring(fileName, np.uint8)
    print("nparray = ", nparray)
    print("\n\n\n\n\n")
    print("Decoded:", cv2.imdecode(nparray, 1))
    print("\n\n\n\n\n")
    print("reading image:", cv2.imdecode(fileName, 1))
